module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    jshint: {
      ...
      all: {
        src: ['package.json', '.jshintrc', 'Gruntfile.js', 'code/**/*.js',
    ...
    exec: {
      crx: {
        cmd: [
          './crxmake.sh build/unpacked-prod ./studypact.pem',
  ...
  grunt.registerTask('watch-build-dev', ['watch:buildDev']);
